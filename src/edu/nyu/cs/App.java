...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.printf("Density of tics: %.1f%%\n", calculateTicDensity(tics, fullText) * 100);
    System.out.println("");
    
    System.out.println("...............................Tic breakdown..................................");
    System.out.println("Tic word    /  Number of occurrences    /  Percentage of all tics");
    System.out.println("------------------------------------------------------------------------------");
    
    for (String tic : tics) {
        int count = countOccurrences(tic, fullText);
        int percentage = calculatePercentage(count, totalTics);
        System.out.printf("%-10s  /  %-20d  /  %-3d%%\n", tic, count, percentage);
    }
 ...
 /**
   ...
   */
    ...
    public static String[] getTicsFromUser() {
      ...
      String ticList = scn.nextLine();
      System.out.println("");
      String[] tics = ticList.split(",");
 ...
 /**
   ...
   */
    ...
    public static int calculatePercentage(int num1, int num2) {
      double prop = (double) num1 / num2;
      double percent= prop * 100.0;
   ...
   */
    ...
    public static double calculateTicDensity(String[] tics, String fullText) {
      ...
      for (String tic : tics) {
        ticCount += countOccurrences(tic, fullText);
      }

      if (totalCount > 0) {
          return (double) ticCount / totalCount;
      } else {
          return 0.0;
      }
  }
